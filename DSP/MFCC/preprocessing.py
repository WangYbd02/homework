...
if __name__ == '__main__':
    ...
    # plt.plot(time_list, wave_data_after, color='b')
    # plt.plot((1.2, 1.2), (-0.2, 0.2), color='r')
    # plt.plot((1.232, 1.232), (-0.2, 0.2), color='r')
    # plt.plot((1.2, 1.232), (-0.2, -0.2), color='r')
    # plt.plot((1.2, 1.232), (0.2, 0.2), color='r')
    #
    # plt.plot((1.216, 1.216), (-0.25, 0.25), color='k')
    # plt.plot((1.248, 1.248), (-0.25, 0.25), color='k')
    # plt.plot((1.216, 1.248), (-0.25, -0.25), color='k')
    # plt.plot((1.216, 1.248), (0.25, 0.25), color='k')
    plt.grid()
    plt.show()
